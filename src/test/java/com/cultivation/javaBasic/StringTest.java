...
class StringTest {
    ...
    void should_convert_unicode_escape() throws UnsupportedEncodingException {
        ...
        // れ - U+308c
        // <--Start
        byte[] utfBytes = expected.getBytes("UTF8");
        final String actual = new String(utfBytes,"UTF8");
        // --End-->
    ...
    void should_compare_string_with_different_cases() {
        ...
        // <--start
        Optional<Boolean> actualResultOfEqual = Optional.of(upperCased.equals(lowerCased));
        Optional<Boolean> actualResultOfEqualIgnoreCase = Optional.of(upperCased.equalsIgnoreCase(lowerCased));
        // --end-->
